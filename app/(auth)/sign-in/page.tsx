...
export default function SignInPage() {
  ...
  return (
    ...
    >
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#e8e8ea]">Sign in</h1>
        <p className="mt-1 text-sm text-[#6b6b7a]">
          Use your email and password to access VEGA.
        </p>
      </div>
      ...
      <p className="mt-6 text-center text-xs text-[#6b6b7a]">
        ...
        <Link href="/sign-up" className="text-[#00e5cc] hover:underline">
          Sign up
        </Link>
      </p>
    </motion.div>
